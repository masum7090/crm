...
<x-app-layout>
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-6">
            <div class="max-w-4xl mx-auto bg-white border rounded-xl shadow-lg p-10 print:shadow-none print:border-none">
                ...
                {{-- Footer --}}
                <div class="mt-12 text-center text-gray-500 text-sm print:hidden">
                    <a href="{{ route('client.invoices.pdf', $invoice->id) }}" class="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-200 transition">
                        Download PDF
                    </a>
                    
                    @if($invoice->status !== 'paid')
                    <a href="{{ route('client.invoices.pay', $invoice->id) }}" class="ml-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
                        Pay Now
                    </a>
                    @endif
                    <a href="{{ route('client.invoices.index') }}" class="ml-4 text-blue-600 hover:underline">
                        Back to My Invoices
                    </a>
                </div>
            </div>
