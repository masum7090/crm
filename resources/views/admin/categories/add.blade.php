    ...
    <div class="bg-white rounded-xl shadow-sm p-8 mt-6">
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <x-input label="Category Name" name="name" :value="old('name')" placeholder="Hosting" />

                <x-input label="Slug" name="slug" :value="old('slug')" placeholder="hosting" />
                ...
                <x-input label="Icon (URL or Path)" name="icon" :value="old('icon')" placeholder="/icons/hosting.png" />
